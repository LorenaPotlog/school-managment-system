...
public class DatabaseInitializer {
    ...
    //    @PostConstruct
    public void init() {
        School school1 = School.builder().name("Sf Nicolae").build();
        School school2 = School.builder().name("Petru Rares").build();
        schoolRepository.save(school1);
        schoolRepository.save(school2);

        Group group1 = Group.builder().name("I-A").school(school1).build();
        Group group2 = Group.builder().name("II-B").school(school1).build();
        Group group3 = Group.builder().name("III-A").school(school2).build();
        Group group4 = Group.builder().name("VI-D").school(school2).build();
